...
def define_parameters():
    ...
    params['first_layer_size'] = 200    # 第一層神經元數量
    params['second_layer_size'] = 20    # 第二層神經元數量
    params['third_layer_size'] = 50     # 第三層神經元數量
    params['episodes'] = 250          
...
if __name__ == '__main__':
    ...
    if params['train']:
        print("訓練中...")
        params['load_weights'] = False   # 在訓練時，網絡不是預先訓練的
        run(params)
    if params['test']:
        print("測試中...")
        params['train'] = False
